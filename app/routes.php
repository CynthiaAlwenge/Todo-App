...
Route::group(array('prefix' => 'admin'), function()
{
	...
	{
		Route::get('/', array('as' => 'todos', 'uses' => 'Controllers\Admin\TodosController@getIndex'));
		Route::get('create', array('as' => 'create/todo', 'uses' => 'Controllers\Admin\TodosController@getCreate'));
		Route::post('create', 'Controllers\Admin\TodosController@postCreate');
		Route::get('{todoId}/edit', array('as' => 'update/todo', 'uses' => 'Controllers\Admin\TodosController@getEdit'));
		Route::post('{todoId}/edit', 'Controllers\Admin\TodosController@postEdit');
		Route::get('{todoId}/delete', array('as' => 'delete/todo', 'uses' => 'Controllers\Admin\TodosController@getDelete'));
		Route::get('{todoId}/restore', array('as' => 'restore/todo', 'uses' => 'Controllers\Admin\TodosController@getRestore'));
	});
